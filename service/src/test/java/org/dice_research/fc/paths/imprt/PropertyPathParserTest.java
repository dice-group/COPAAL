...
public class PropertyPathParserTest {
  ...
  public PropertyPathParserTest(String propertyPath, List<Pair<Property, Boolean>> expected, QRestrictedPath path) {
  ...
  public static Collection<Object[]> data() {
    ...
    testConfigs.add(new Object[] {"<http://example.org#randomProperty2>", exp1, new QRestrictedPath(exp1)});
    
    List<Pair<Property, Boolean>> exp2 = new ArrayList<Pair<Property, Boolean>>();
    exp2.add(new Pair<Property, Boolean>(prop2, false));
    testConfigs.add(new Object[] {"^<http://example.org#randomProperty2>", exp2, new QRestrictedPath(exp2)});
    ...
    testConfigs.add(new Object[] {"<http://example.org#randomProperty2>/^<http://example.org#randomProperty3>", exp3, new QRestrictedPath(exp3)});
    ...
    testConfigs.add(new Object[] {"<http://example.org#randomProperty2>/<http://example.org#randomProperty3>", exp4, new QRestrictedPath(exp4)});
    ...
    testConfigs.add(new Object[] {"<http://example.org#randomProperty2>/<http://example.org#randomProperty3>/^<http://example.org#randomProperty3>", exp5, new QRestrictedPath(exp5)});
