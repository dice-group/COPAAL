...
public class ApproximatingCountRetrieverTest {
  ...
  public void test() {
    ...
    ICountRetriever appCountRetriever = new ApproximatingCountRetriever(qef, new DefaultMaxCounter(qef), new ListBaseQueryValidator(new ArrayList<>()));
