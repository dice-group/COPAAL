...
public class ApproximatingCountRetriever extends AbstractSPARQLBasedCountRetriever {
  ...
  protected void addTriplePattern(Pair<Property, Boolean> pathElement,
      String firstVariable, String secondVariable, StringBuilder builder) {
  ...
  private StringBuilder createSinglePropertyQuery(QRestrictedPath path, ITypeRestriction domainRestriction,
      ITypeRestriction rangeRestriction) {
    StringBuilder queryBuilder = new StringBuilder();
    queryBuilder.append("SELECT count(*) AS ?");
    queryBuilder.append(COUNT_VARIABLE_NAME);
  ...
  private StringBuilder createPropertyQueryRecursively(QRestrictedPath path, ITypeRestriction domainRestriction,
      ITypeRestriction rangeRestriction) {
      StringBuilder queryBuilder = new StringBuilder();
