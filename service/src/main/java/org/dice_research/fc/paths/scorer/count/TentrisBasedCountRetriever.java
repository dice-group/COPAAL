...
/**
 * This implementation of the {@link ICountRetriever} interface retrieves counts by using a
 * {@link TentrisAdapter}. The adapter will call the /count method of Tentris and, hencen, the
 * queries are SELECT queries that do not contain a count statement.
 *
