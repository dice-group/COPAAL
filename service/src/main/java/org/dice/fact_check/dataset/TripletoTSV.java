...
public class TripletoTSV {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try (BufferedWriter writer =
        new BufferedWriter(new FileWriter(new File("/home/datascienceadmin/dbpedia.tsv")))) {

      ParameterizedSparqlString pss = new ParameterizedSparqlString(
          "Select ?s ?p ?o {" + "Graph <http://dbpedia.org> {" + "?s ?p ?o } }");
      qef = new QueryExecutionFactoryHttp("http://131.234.29.111:8890/sparql");
